...
public class OrderEntryResource {
    ...
    @Timed
    public ResponseEntity<OrderEntry> createOrderEntry(@RequestBody OrderEntry orderEntry) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<OrderEntry> updateOrderEntry(@RequestBody OrderEntry orderEntry) throws URISyntaxException {
