...
import com.epam.rd.shaurmastore.config.audit.AuditEventConverter;
import com.epam.rd.shaurmastore.domain.PersistentAuditEvent;
...
import static com.epam.rd.shaurmastore.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
