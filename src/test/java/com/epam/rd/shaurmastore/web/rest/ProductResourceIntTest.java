...
import com.epam.rd.shaurmastore.repository.ProductRepository;
...
public class ProductResourceIntTest {
    ...
    private static final ProductType DEFAULT_TYPE = ProductType.MEAT;
    private static final ProductType UPDATED_TYPE = ProductType.VEGETABLE;
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.isIsMandatory()).isEqualTo(DEFAULT_IS_MANDATORY);
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.isIsMandatory()).isEqualTo(UPDATED_IS_MANDATORY);
