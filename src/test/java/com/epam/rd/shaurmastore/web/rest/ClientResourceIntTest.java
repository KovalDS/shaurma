...
import com.epam.rd.shaurmastore.repository.ClientRepository;
...
public class ClientResourceIntTest {
    ...
    public void createClient() throws Exception {
        ...
        assertThat(testClient.getNumberOfPoints()).isEqualTo(DEFAULT_NUMBER_OF_POINTS);
    }
    ...
    public void updateClient() throws Exception {
        ...
        assertThat(testClient.getNumberOfPoints()).isEqualTo(UPDATED_NUMBER_OF_POINTS);
    }
